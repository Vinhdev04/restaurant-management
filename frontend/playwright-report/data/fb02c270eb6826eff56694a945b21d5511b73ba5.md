...
- Name: home.spec.js >> Trang chủ >> Hiển thị trang chủ với các tính năng chính
- Location: tests\home.spec.js:5:3
...
Locator: locator('text=500+')
Expected: visible
Error: strict mode violation: locator('text=500+') resolved to 2 elements:
    1) <span class="_trustText_v2ry3_288">500+ nhà hàng</span> aka getByText('+ nhà hàng')
    2) <h3 class="_statNumber_v2ry3_549">500+</h3> aka getByRole('heading', { name: '500+' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=500+')
  ...
  - main [ref=e68]:
    - generic [ref=e69]:
      ...
      - generic [ref=e138]:
        ...
        - generic [ref=e144]:
          - link "🍽️ Quản lý thực đơn Dễ dàng cập nhật món ăn, giá cả và hình ảnh với giao diện trực quan" [ref=e145]:
            - /url: /menu
            - generic [ref=e146]: 🍽️
            ...
            - img [ref=e150]
          - link "📋 Đặt bàn trực tuyến Khách hàng đặt bàn nhanh chóng, quản lý reservation hiệu quả" [ref=e152]:
            - /url: /reservation
            - generic [ref=e153]: 📋
            ...
            - img [ref=e157]
          - link "👨‍🍳 Kết nối bếp Đồng bộ đơn hàng realtime từ bàn ăn đến khu vực bếp" [ref=e159]:
            - /url: /admin/dashboard
            - generic [ref=e160]: 👨‍🍳
            - heading "Kết nối bếp" [level=3] [ref=e161]
            - paragraph [ref=e162]: Đồng bộ đơn hàng realtime từ bàn ăn đến khu vực bếp
            - img [ref=e164]
          - link "💳 Thanh toán nhanh Xử lý bill, áp dụng khuyến mãi và in hóa đơn tự động" [ref=e166]:
            - /url: /admin/dashboard
            - generic [ref=e167]: 💳
            - heading "Thanh toán nhanh" [level=3] [ref=e168]
            - paragraph [ref=e169]: Xử lý bill, áp dụng khuyến mãi và in hóa đơn tự động
            - img [ref=e171]
          - link "📊 Báo cáo chi tiết Thống kê doanh thu, món bán chạy theo ngày/tháng/năm" [ref=e173]:
            - /url: /admin/dashboard
            - generic [ref=e174]: 📊
            - heading "Báo cáo chi tiết" [level=3] [ref=e175]
            - paragraph [ref=e176]: Thống kê doanh thu, món bán chạy theo ngày/tháng/năm
            - img [ref=e178]
          - link "👥 Quản lý nhân sự Phân quyền, theo dõi hiệu suất làm việc của từng nhân viên" [ref=e180]:
            - /url: /admin/dashboard
            - generic [ref=e181]: 👥
      ...
      - generic [ref=e230]:
        ...
        - generic [ref=e234]:
          - link "Trải nghiệm ngay" [ref=e235]:
            - /url: /login
            - generic [ref=e236]: Trải nghiệm ngay
            - img [ref=e237]
          - link "Tìm hiểu thêm" [ref=e239]:
            - /url: /menu
  ...
  - contentinfo [ref=e244]:
    - generic [ref=e247]:
      ...
      - generic [ref=e261]:
        ...
        - list [ref=e263]:
          - listitem [ref=e264]:
            - link "→ Trang chủ" [ref=e265]:
              - /url: /
              - generic [ref=e266]: →
              - generic [ref=e267]: Trang chủ
          - listitem [ref=e268]:
            - link "→ Thực đơn" [ref=e269]:
              - /url: /menu
              - generic [ref=e270]: →
              - generic [ref=e271]: Thực đơn
          - listitem [ref=e272]:
            - link "→ Đặt bàn" [ref=e273]:
              - /url: /reservation
              - generic [ref=e274]: →
              - generic [ref=e275]: Đặt bàn
          - listitem [ref=e276]:
            - link "→ Về chúng tôi" [ref=e277]:
              - /url: /about
              - generic [ref=e278]: →
      ...
      - generic [ref=e280]:
        ...
        - list [ref=e282]:
          - listitem [ref=e283]:
            - link "→ Dashboard" [ref=e284]:
              - /url: /admin/dashboard
              - generic [ref=e285]: →
              - generic [ref=e286]: Dashboard
          - listitem [ref=e287]:
            - link "→ Quản lý đơn hàng" [ref=e288]:
              - /url: /admin/orders
              - generic [ref=e289]: →
              - generic [ref=e290]: Quản lý đơn hàng
          - listitem [ref=e291]:
            - link "→ Quản lý bàn" [ref=e292]:
              - /url: /admin/tables
              - generic [ref=e293]: →
              - generic [ref=e294]: Quản lý bàn
          - listitem [ref=e295]:
            - link "→ Báo cáo" [ref=e296]:
              - /url: /admin/reports
              - generic [ref=e297]: →
        ...
        - generic [ref=e301]:
          ...
          - generic [ref=e313]:
            ...
            - generic [ref=e315]:
              ...
              - paragraph [ref=e317]:
                - link "contact@restaurant.com" [ref=e318]:
    ...
    - generic [ref=e321]:
      ...
      - generic [ref=e324]:
        - link "Chính sách bảo mật" [ref=e325]:
          - /url: /privacy
        - generic [ref=e326]: "|"
        - link "Điều khoản sử dụng" [ref=e327]:
          - /url: /terms
        - generic [ref=e328]: "|"
        - link "Sitemap" [ref=e329]:
          - /url: /sitemap
```
...
```ts
  ...
  2  | 
  3  | // Kịch bản test: Kiểm tra trang chủ
  4  | test.describe('Trang chủ', () => {
  5  |   test('Hiển thị trang chủ với các tính năng chính', async ({ page }) => {
  6  |     // Điều hướng đến trang chủ
  7  |     await page.goto('/');
  8  | 
  9  |     // Kiểm tra tiêu đề trang
  10 |     await expect(page).toHaveTitle(/Restaurant Management/);
  11 | 
  12 |     // Kiểm tra các tính năng được hiển thị
  13 |     await expect(page.locator('text=Quản lý thực đơn')).toBeVisible();
  14 |     await expect(page.locator('text=Đặt bàn trực tuyến')).toBeVisible();
  15 |     await expect(page.locator('text=Kết nối bếp')).toBeVisible();
  16 |     await expect(page.locator('text=Thanh toán nhanh')).toBeVisible();
  17 |     await expect(page.locator('text=Báo cáo chi tiết')).toBeVisible();
  18 |     await expect(page.locator('text=Quản lý nhân sự')).toBeVisible();
  19 | 
  20 |     // Kiểm tra thống kê
  21 |     await expect(page.locator('text=1000+')).toBeVisible();
> 22 |     await expect(page.locator('text=500+')).toBeVisible();
     |                                             ^ Error: expect(locator).toBeVisible() failed
  23 |     await expect(page.locator('text=4.9/5')).toBeVisible();
  24 |     await expect(page.locator('text=24/7')).toBeVisible();
  25 |   });
  26 | 
  27 |   test('Điều hướng đến trang thực đơn từ trang chủ', async ({ page }) => {
  28 |     await page.goto('/');
  29 | 
  30 |     // Click vào liên kết thực đơn
  31 |     await page.locator('text=Quản lý thực đơn').click();
  32 | 
  33 |     // Kiểm tra đã chuyển đến trang thực đơn
  34 |     await expect(page).toHaveURL(/.*menu/);
  35 |   });
  36 | 
  37 |   test('Điều hướng đến trang đặt bàn từ trang chủ', async ({ page }) => {
  38 |     await page.goto('/');
  39 | 
  40 |     // Click vào liên kết đặt bàn
  41 |     await page.locator('text=Đặt bàn trực tuyến').click();
  42 | 
  43 |     // Kiểm tra đã chuyển đến trang đặt bàn
  44 |     await expect(page).toHaveURL(/.*reservation/);
  45 |   });
  46 | });
```